                                ...
                                <div class="row3">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6">		          	
                                            ...
                                            <div class="templatemo-input-icon-container">
                                                <i class="fa fa-user"></i>
                                                <input name="titulo" type = "text"  class="form-control" id="titulo" placeholder = "t�tulo" required>
                                            </div>		            		            		            
                                        </div> 
                                        <div class="col-md-6">	


                                            <label for="anoPublicacao" class="control-label">Ano de Publica��o</label>
                                            <div class="templatemo-input-icon-container">
                                                <i class="fa fa-lock"></i>
                                                <input name="anoPublicacao" type = "text" class = "form-control" id = "anoPublicacao" placeholder = "Ano de publica��o" required>
                                            </div>
